...
export const wrapperElement = document.querySelector('.inputWrapper');
export const updateButtonElement = document.querySelector('.update');
export const restartButtonElement = document.querySelector('.restart');
export const testStatsElement = document.querySelector('.dialog');
export const mainDocumentElement = document.documentElement;
export const accuracyCircleElement = document.querySelector('.progress-fill-accuracy');
